 ...
 */
export declare enum MavEcho1dMode {
    'SIMPLE_MODE' = 0,
    'FULL_MODE' = 1,
    'PAUSE' = 2,
    'STOP' = 3,
 ...
 * Operating modes of the CAN echo sounder.
 */
export declare enum MavEcho1dGainSettings {
    'MAV_ECHO_1D_GAIN_0_6' = 0,
    'MAV_ECHO_1D_GAIN_1_8' = 1,
    'MAV_ECHO_1D_GAIN_5_5' = 2,
    'MAV_ECHO_1D_GAIN_12_9' = 3,
    'MAV_ECHO_1D_GAIN_30_2' = 4,
    'MAV_ECHO_1D_GAIN_66_1' = 5,
    'MAV_ECHO_1D_GAIN_144' = 6
}
/**
 * Operating modes of the CAN echo sounder.
 */
export declare enum MavEcho1dErrors {
    'BAR_OVER_CURRENT' = 1,
    'SD_FULL' = 2,
    'SD_EMPTY' = 4,
    'SD_MOUNTING_ERROR' = 8,
 ...
 * Operating modes of the CAN echo sounder.
 */
export declare enum MavEcho1dBarState {
    'UP' = 0,
    'GO_DOWN' = 1,
    'GO_UP' = 2,
    'DOWN' = 3,
 ...
 * Types of components.
 */
export declare enum MavComponentId {
    'CS' = 0,
    'BK_LOW' = 1,
    'BK_HIGH' = 2,
    'ECHO_1D' = 3
 ...
 */
export declare class Echo1dSensorMainMsg extends MavLinkData {
    static MSG_ID: number;
    static MSG_NAME: string;
    static PAYLOAD_LENGTH: number;
    static MAGIC_NUMBER: number;
...
export declare class Echo1dSensorLongMsg extends MavLinkData {
     ...
     */
    profileDataLength: uint16_t;
    /**
     * An array of return strength measurements taken at regular intervals across the scan region. The
     * first element is the closest measurement to the sensor, and the last element is the farthest
