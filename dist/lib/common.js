 ...
 * use the following naming conventions:
 - `LOCAL`: Origin of local frame is fixed relative to earth.
 * Unless otherwise specified this origin is the origin of the vehicle position-estimator ("EKF").
 -
 ...
 * frame axis with vehicle attitude.
 - `OFFSET`: Deprecated synonym for `BODY` (origin travels with
 * the vehicle). Not to be used for new frames.
 
 Some deprecated frames do not follow these
 * conventions (e.g. MAV_FRAME_BODY_NED and MAV_FRAME_BODY_OFFSET_NED).
 */
var MavFrame;
(function (MavFrame) {
    /**
...
(function (MavCmd) {
    ...
    MavCmd[MavCmd["ECHO_1D"] = 31015] = "ECHO_1D";
})(MavCmd = exports.MavCmd || (exports.MavCmd = {}));
/**
 * Operating modes of the CAN echo sounder.
 */
var MavEcho1dMode;
(function (MavEcho1dMode) {
    MavEcho1dMode[MavEcho1dMode["SIMPLE_MODE"] = 0] = "SIMPLE_MODE";
    MavEcho1dMode[MavEcho1dMode["FULL_MODE"] = 1] = "FULL_MODE";
    MavEcho1dMode[MavEcho1dMode["PAUSE"] = 2] = "PAUSE";
    MavEcho1dMode[MavEcho1dMode["STOP"] = 3] = "STOP";
    MavEcho1dMode[MavEcho1dMode["UPPER_THE_BAR"] = 4] = "UPPER_THE_BAR";
    MavEcho1dMode[MavEcho1dMode["LOWER_THE_BAR"] = 5] = "LOWER_THE_BAR";
    MavEcho1dMode[MavEcho1dMode["SWITCH_ON"] = 6] = "SWITCH_ON";
})(MavEcho1dMode = exports.MavEcho1dMode || (exports.MavEcho1dMode = {}));
/**
 * Operating modes of the CAN echo sounder.
 */
var MavEcho1dGainSettings;
(function (MavEcho1dGainSettings) {
    MavEcho1dGainSettings[MavEcho1dGainSettings["MAV_ECHO_1D_GAIN_0_6"] = 0] = "MAV_ECHO_1D_GAIN_0_6";
    MavEcho1dGainSettings[MavEcho1dGainSettings["MAV_ECHO_1D_GAIN_1_8"] = 1] = "MAV_ECHO_1D_GAIN_1_8";
    MavEcho1dGainSettings[MavEcho1dGainSettings["MAV_ECHO_1D_GAIN_5_5"] = 2] = "MAV_ECHO_1D_GAIN_5_5";
    MavEcho1dGainSettings[MavEcho1dGainSettings["MAV_ECHO_1D_GAIN_12_9"] = 3] = "MAV_ECHO_1D_GAIN_12_9";
    MavEcho1dGainSettings[MavEcho1dGainSettings["MAV_ECHO_1D_GAIN_30_2"] = 4] = "MAV_ECHO_1D_GAIN_30_2";
    MavEcho1dGainSettings[MavEcho1dGainSettings["MAV_ECHO_1D_GAIN_66_1"] = 5] = "MAV_ECHO_1D_GAIN_66_1";
    MavEcho1dGainSettings[MavEcho1dGainSettings["MAV_ECHO_1D_GAIN_144"] = 6] = "MAV_ECHO_1D_GAIN_144";
})(MavEcho1dGainSettings = exports.MavEcho1dGainSettings || (exports.MavEcho1dGainSettings = {}));
/**
 * Operating modes of the CAN echo sounder.
 */
var MavEcho1dErrors;
(function (MavEcho1dErrors) {
    MavEcho1dErrors[MavEcho1dErrors["BAR_OVER_CURRENT"] = 1] = "BAR_OVER_CURRENT";
    MavEcho1dErrors[MavEcho1dErrors["SD_FULL"] = 2] = "SD_FULL";
    MavEcho1dErrors[MavEcho1dErrors["SD_EMPTY"] = 4] = "SD_EMPTY";
    MavEcho1dErrors[MavEcho1dErrors["SD_MOUNTING_ERROR"] = 8] = "SD_MOUNTING_ERROR";
    MavEcho1dErrors[MavEcho1dErrors["SD_WRITE_ERROR"] = 16] = "SD_WRITE_ERROR";
    MavEcho1dErrors[MavEcho1dErrors["DO_NOT_USE"] = 32] = "DO_NOT_USE";
    MavEcho1dErrors[MavEcho1dErrors["SENSOR_ERROR"] = 64] = "SENSOR_ERROR";
    MavEcho1dErrors[MavEcho1dErrors["EEPROM_ERROR"] = 128] = "EEPROM_ERROR";
})(MavEcho1dErrors = exports.MavEcho1dErrors || (exports.MavEcho1dErrors = {}));
/**
 * Operating modes of the CAN echo sounder.
 */
var MavEcho1dBarState;
(function (MavEcho1dBarState) {
    MavEcho1dBarState[MavEcho1dBarState["UP"] = 0] = "UP";
    MavEcho1dBarState[MavEcho1dBarState["GO_DOWN"] = 1] = "GO_DOWN";
    MavEcho1dBarState[MavEcho1dBarState["GO_UP"] = 2] = "GO_UP";
    MavEcho1dBarState[MavEcho1dBarState["DOWN"] = 3] = "DOWN";
    MavEcho1dBarState[MavEcho1dBarState["GO_DOWN_ERROR"] = 4] = "GO_DOWN_ERROR";
    MavEcho1dBarState[MavEcho1dBarState["GO_UP_ERROR"] = 5] = "GO_UP_ERROR";
})(MavEcho1dBarState = exports.MavEcho1dBarState || (exports.MavEcho1dBarState = {}));
/**
...
(function (MavDataStream) {
    ...
    MavDataStream[MavDataStream["ECHO_1D"] = 13] = "ECHO_1D";
})(MavDataStream = exports.MavDataStream || (exports.MavDataStream = {}));
/**
 * Types of components.
 */
var MavComponentId;
(function (MavComponentId) {
    MavComponentId[MavComponentId["CS"] = 0] = "CS";
    MavComponentId[MavComponentId["BK_LOW"] = 1] = "BK_LOW";
    MavComponentId[MavComponentId["BK_HIGH"] = 2] = "BK_HIGH";
    MavComponentId[MavComponentId["ECHO_1D"] = 3] = "ECHO_1D";
    MavComponentId[MavComponentId["SMART_BATTERY"] = 4] = "SMART_BATTERY";
})(MavComponentId = exports.MavComponentId || (exports.MavComponentId = {}));
/**
 ...
 */
var MavCommunicationErrors;
(function (MavCommunicationErrors) {
    MavCommunicationErrors[MavCommunicationErrors["NONE"] = 0] = "NONE";
    MavCommunicationErrors[MavCommunicationErrors["UART"] = 1] = "UART";
    MavCommunicationErrors[MavCommunicationErrors["I2C"] = 2] = "I2C";
    MavCommunicationErrors[MavCommunicationErrors["SPI"] = 4] = "SPI";
    MavCommunicationErrors[MavCommunicationErrors["CAN"] = 8] = "CAN";
})(MavCommunicationErrors = exports.MavCommunicationErrors || (exports.MavCommunicationErrors = {}));
/**
 ...
 */
class Echo1dSensorMainMsg extends mavlink_1.MavLinkData {
}
exports.Echo1dSensorMainMsg = Echo1dSensorMainMsg;
Echo1dSensorMainMsg.MSG_ID = 20000;
Echo1dSensorMainMsg.MSG_NAME = 'ECHO_1D_SENSOR_MAIN_MSG';
Echo1dSensorMainMsg.PAYLOAD_LENGTH = 8;
Echo1dSensorMainMsg.MAGIC_NUMBER = 32;
Echo1dSensorMainMsg.FIELDS = [
    new mavlink_1.MavLinkPacketField('distance', 'distance', 0, false, 4, 'uint32_t', 'mm'),
    new mavlink_1.MavLinkPacketField('confidence', 'confidence', 4, false, 2, 'uint16_t', '%'),
    new mavlink_1.MavLinkPacketField('errors', 'errors', 6, false, 1, 'uint8_t', ''),
...
exports.Echo1dSensorLongMsg = Echo1dSensorLongMsg;
Echo1dSensorLongMsg.MSG_ID = 20001;
Echo1dSensorLongMsg.MSG_NAME = 'ECHO_1D_SENSOR_LONG_MSG';
Echo1dSensorLongMsg.PAYLOAD_LENGTH = 227;
Echo1dSensorLongMsg.MAGIC_NUMBER = 234;
 ...
 * The state of the navigation and position controller.
 */
class MainVehicleInfo extends mavlink_1.MavLinkData {
}
exports.MainVehicleInfo = MainVehicleInfo;
MainVehicleInfo.MSG_ID = 20101;
MainVehicleInfo.MSG_NAME = 'MAIN_VEHICLE_INFO';
MainVehicleInfo.PAYLOAD_LENGTH = 40;
MainVehicleInfo.MAGIC_NUMBER = 242;
MainVehicleInfo.FIELDS = [
    new mavlink_1.MavLinkPacketField('vessel_type', 'vesselType', 0, false, 4, 'uint32_t', ''),
    new mavlink_1.MavLinkPacketField('major_version', 'majorVersion', 4, false, 4, 'uint32_t', ''),
    new mavlink_1.MavLinkPacketField('mainor_version', 'mainorVersion', 8, false, 4, 'uint32_t', ''),
    new mavlink_1.MavLinkPacketField('patch_version', 'patchVersion', 12, false, 4, 'uint32_t', ''),
    new mavlink_1.MavLinkPacketField('build_number', 'buildNumber', 16, false, 4, 'uint32_t', ''),
    new mavlink_1.MavLinkPacketField('serial_number', 'serialNumber', 20, false, 1, 'uint8_t[]', '', 20),
];
exports.REGISTRY = {
    1: SysStatus,
    2: SystemTime,
